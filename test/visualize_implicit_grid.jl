using Homogenization: refined_element, Tris, Mesh, Tris64, Tets64, affine_map,
                      ...
                      construct_full_grid, ZeroDirichletConstraint, 
                      list_boundary_nodes_edges_faces, refined_mesh, apply_constraint!
using StaticArrays
using WriteVTK
